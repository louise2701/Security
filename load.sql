...
INSERT INTO `order_client` (email, `password`, first_name, last_name, phone_number, `address`, postal_code, credit_card) VALUES 
('test@test', 'test', 'testFName', 'testLName', '0123456789', 'testAddress', '12345', '1234567891234567'),
('john.doe@email.com', 'motdepasse1', 'John', 'Doe', '1234567890', '123 Rue des Fleurs', '75001', '1111222233334444'),
('jane.smith@email.com', 'motdepasse2', 'Jane', 'Smith', '9876543210', '456 Avenue des Étoiles', '75002', '2222333344445555'),
('alice.johnson@email.com', 'motdepasse3', 'Alice', 'Johnson', '5556667777', '789 Boulevard du Soleil', '75003', '3333444455556666'),
('bob.williams@email.com', 'motdepasse4', 'Bob', 'Williams', '3332221111', '1010 Rue de la Lune', '75004', '4444555566667777'),
('emma.martin@email.com', 'motdepasse5', 'Emma', 'Martin', '9998887777', '2020 Avenue des Nuages', '75005', '5555666677778888'),
('charlie.brown@email.com', 'motdepasse6', 'Charlie', 'Brown', '1110009999', '303 Rue des Montagnes', '75006', '6666777788889999'),
('olivia.white@email.com', 'motdepasse7', 'Olivia', 'White', '7776665555', '404 Avenue des Rivières', '75007', '7777888899990000'),
('michael.davis@email.com', 'motdepasse8', 'Michael', 'Davis', '4443332222', '505 Boulevard des Forêts', '75008', '8888999900001111'),
('sophia.thomas@email.com', 'motdepasse9', 'Sophia', 'Thomas', '2221110000', '606 Rue des Champs', '75009', '9999000011112222'),
('liam.jackson@email.com', 'motdepasse10', 'Liam', 'Jackson', '8887776666', '707 Avenue des Plaines', '75010', '0000111122223333');

INSERT INTO `order_order` (order_id, order_date, delivery_date, delivery_address, delivery_postal_code, `status`, total_price, email_id) VALUES 
